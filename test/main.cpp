...
int main()
{
    ...
    while (1)
    {
        ...
        if(please.find("dir")!= std::string::npos||please.find("help")!= std::string::npos||please.find("vol")!= std::string::npos||please.find("path")!= std::string::npos||please.find("tasklist")!= std::string::npos||please.find("notepad")!= std::string::npos||please.find("echo")!= std::string::npos||please.find("color")!= std::string::npos||please.find("ping")!= std::string::npos){cout<<"omg";
